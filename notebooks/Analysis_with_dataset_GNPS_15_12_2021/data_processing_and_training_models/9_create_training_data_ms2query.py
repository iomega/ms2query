...
assert os.path.exists(os.path.join(path_data, "library_GNPS_15_12", f"spec2vec_model_GNPS_{file_date}.model"))
assert os.path.exists(os.path.join(path_data, "library_GNPS_15_12", f"ms2ds_model_GNPS_{file_date}.hdf5"))
...
assert os.path.exists(os.path.join(path_data, "in_between_files", "ms2q_train_spectra.pickle"))
assert os.path.exists(os.path.join(path_data, "in_between_files", "ms2q_val_spectra.pickle"))
assert os.path.exists(os.path.join(path_data, "in_between_files", f"GNPS_{file_date}_pos_tanimoto_scores.pickle"))

collector = DataCollectorForTraining(
    os.path.join(path_data, "library_GNPS_15_12", f"library_GNPS_{file_date}.sqlite"),
    os.path.join(path_data, "library_GNPS_15_12", f"spec2vec_model_GNPS_{file_date}.model"),
    os.path.join(path_data, "library_GNPS_15_12", f"ms2ds_model_GNPS_{file_date}.hdf5"),
    ...
    os.path.join(path_data, "in_between_files", "ms2q_train_spectra.pickle"),
    os.path.join(path_data, "in_between_files", "ms2q_val_spectra.pickle"),
    os.path.join(path_data, "in_between_files", f"GNPS_{file_date}_pos_tanimoto_scores.pickle"),

...
collector = DataCollectorForTraining(
    os.path.join(path_negative_mode, f"neg_library_GNPS_{file_date}.sqlite"),
    os.path.join(path_negative_mode, f"neg_mode_spec2vec_model_GNPS_{file_date}.model"),
    os.path.join(path_negative_mode, f"ms2ds_GNPS_{file_date}.hdf5"),
    os.path.join(path_negative_mode, f"neg_library_GNPS_{file_date}_s2v_embeddings.pickle"),
    os.path.join(path_negative_mode, f"neg_library_GNPS_{file_date}_ms2ds_embeddings.pickle"),

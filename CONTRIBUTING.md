...
1. use the search functionality [here](https://github.com/iomega/ms2query/issues) to see if someone already filed the same issue;
...
1. [push](http://rogerdudler.github.io/git-guide/>) your feature branch to (your fork of) the ms2query repository on GitHub;
...
1. Change the version number in `__version__.py` and.
1. Update the `CHANGELOG.md` to include changes made
1. Goto [GitHub release page](https://github.com/iomega/ms2query/releases)

...
def load_all_test_results(nr_of_test_results, base_directory):
...
def load_results_from_folder(test_results_folder: str) -> Dict[str, List[Tuple[float, float, bool]]]:
    dict_with_results = {}
...
if __name__ == "__main__":
    test_results_folder = "../../data/libraries_and_models/gnps_01_11_2022/negative_mode/exact_matches_test_sets/"
    # dict_with_results = load_all_test_results(20, test_results_folder)
    # means_and_standard_deviation = calculate_all_means_and_standard_deviation(dict_with_results, exact_matches=True)
    ...
    plot_all_with_standard_deviation(means_and_standard_deviation,
                                     save_figure_file_name=os.path.join(test_results_folder, "recall_vs_accuracy_neg_exact_matches.svg")
                                     )

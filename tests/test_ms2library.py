import os
import pickle
# todo uncomment import statements when test functions are fully functional
# import pandas as pd
...
# todo Large .hdf5 model file cannot be loaded on github.
#  Uncomment when found solution
...
# todo Large model file cannot be loaded on github. (Also the syn1neg.npy and
#  wv.vectors.npy are needed. Uncomment when found solution
...
#         "../../ms2deepscore/data/ms2ds_siamese_210207_ALL_GNPS_positive_L1L2.hdf5"
